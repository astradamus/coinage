...
public class Perception {
  ...
  /**
   * Evaluates whether or not coordinate {@code to} can be seen from coordinate {@code from} by
   * an actor with the given {@code perceptionRank} facing direction {@code currentFacing}. For
   * each point of perception, an actor may see across two additional squares' distance.
   */
  ...
  /**
   * Evaluates whether or not a noise at the given {@code to} coordinate can be heard from the
   * given {@code from} coordinate by an actor with the given {@code perceptionRank}. For each
   * point of perception, an actor may hear across one additional square's distance.
   */
   ...
   * given {@code from} coordinate by an actor with the given {@code perceptionRank}. For each
   * four points of perception, an actor may track across one additional area's distance. Actors
   * with less than four points of perception can still always track a minimum of one area's
