...
/**
 * Observes WASD presses/releases to determine which direction the player wants to go. Pressing
 ...
 * pressed.
 */
class WASDDirectionInterpreter implements KeyListener {

  private final DirectionListener directionListener;

  private final Stack<Direction> heldDirections = new Stack<>();

  public WASDDirectionInterpreter(DirectionListener directionListener) {
