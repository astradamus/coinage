...
public class EventLog {
  ...
  public static void drawOverlay(Graphics2D g2d) {
    ...
    final AreaCoordinate playerAt = GameDisplay.getRunningGame().getWorld()
        .convertToAreaCoordinate(GameDisplay.getRunningGame().getActivePlayerActor().getCoordinate());

    final Dimension areaSizeInSquares = GameDisplay.getRunningGame().getWorld().getAreaSizeInSquares();
  ...
  public static void registerEventIfPlayerIsNear(Coordinate nearTo, Color color, String message) {
    final Area playerAt = GameDisplay.getRunningGame().getWorld().getArea(GameDisplay.getRunningGame().getActivePlayerActor().getCoordinate());
