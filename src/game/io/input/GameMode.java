  ...
  LOOK {
    ...
    public List<DisplayElement> getDisplayElements() {
      return Arrays.asList(
          ...
          DisplayElement.makePhysicalsList(GameInput.getRunningGame().getWorld().getSquare(GameInput
  ...
  INTERACT {
    ...
    public List<DisplayElement> getDisplayElements() {
      ...
      DisplayElement_Text physicalsAtTarget = (playerTarget == null) ? null :
          DisplayElement.makePhysicalsList(GameInput.getRunningGame().getWorld().getSquare(playerTarget).getAll(), true);
    ...
    public List<DisplayElement> getDisplayElements() {
      ...
      DisplayElement_Text itemsHeld =
          DisplayElement.makePhysicalsList(GameInput.getRunningGame()
              .getActivePlayerActor().getInventory().getItemsHeld(), true);
